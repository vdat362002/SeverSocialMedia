...
export default function (passport) {
    ...
    passport.use(
        ...
        new FacebookStrategy.Strategy({
            clientID: process.env.FACEBOOK_CLIENT_ID || '1234567',
            clientSecret: process.env.FACEBOOK_CLIENT_SECRET || '1234567',
    ...
    passport.use(
        ...
        new GitHubStrategy.Strategy({
            clientID: process.env.GITHUB_CLIENT_ID || '1234567',
            clientSecret: process.env.GITHUB_CLIENT_SECRET || '1234567',
    ...
    passport.use(
        ...
        new GoogleStrategy.Strategy(
            {
                clientID: process.env.GOOGLE_CLIENT_ID || '1234567',
                clientSecret: process.env.GOOGLE_CLIENT_SECRET || '1234567',
